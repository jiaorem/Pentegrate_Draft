...
<body>
    <div class="container">
        <div class="navbar">
            <div class="logo">
                <a href="home.php"><img src="images/logo.png" alt="logo" width="125px"></a>
            </div>
            <nav>
                    <ul id="MenuItems">
    ...
    <div class="small-container cart-page">
        ...
        <div class="total-price">
            <table>
                ...
                <tr>
                <td>
                <button type="submit" name="submit" value="check-out" class="buy_now"> Checkout</button>
                </td>
                </tr>
            </table>
        </div>
        ...
        $(document).ready(function(){
           $(".buy_now").on('click',function(e){
                e.preventDefault();
                    ...
                    var url = 'http://localhost/ipt10-strapi-ecommerce/checkout.php?'+dt; 
